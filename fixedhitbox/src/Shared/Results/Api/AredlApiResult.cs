...
namespace fixedhitbox.Shared.Results.Api;

public sealed class AredlApiResult<T>
{

    public EAredlApiStatus Status { get; }
    public T? Data { get; }
    ...
    public static AredlApiResult<T> Timeout(string errorMessage)
        => new(EAredlApiStatus.Timeout, default, errorMessage);
}